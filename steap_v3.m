...
arm_model = Pose2MobileArmModel(marm, sphere_vec);
...
% prior to start/goal
pose_fix = noiseModel.Isotropic.Sigma(arm_model.dof(), 0.0001);
vel_fix = noiseModel.Isotropic.Sigma(arm_model.dof(), 0.0001);
